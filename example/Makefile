...
ISI_DIR = ../isi
CWM_DIR = ../../../../cast-wicket-modules/branches/wicket-1.5
DRAW_DIR = ../../../../cwm-drawtool/branches/wicket-1.5
...
toolkit-bundle.zip:
	...
	@echo "Bundle file created.  Remember to RENAME it before uploading to Google Code - the download name must be unique"
