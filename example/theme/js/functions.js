...
function linkToggleShow(toggleId, scope, follow) {
    ...
    $(".linkToggleBox_" + toggleId, scope).slideDown().attr("aria-expanded", "true").attr("aria-hidden", "false");
    if (follow) {
...
function linkToggleHide(toggleId, scope, follow) {
    ...
    $(".linkToggleBox_" + toggleId, scope).slideUp().attr("aria-expanded", "false").attr("aria-hidden", "true");
    if (follow) {
